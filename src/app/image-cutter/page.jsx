...
const ImageCutter = () => {
  ...
  //   setAddWatermark(event.target.checked); // Atualiza o estado da checkbox
  // };

//  const applyWatermark = (ctx, canvasSize) => {
//   const watermark = new Image();
//   const watermarkUrl = 'https://i.postimg.cc/cJnKqhgV/logo-ismafer.jpg'
//   watermark.crossOrigin = 'Anonymous'; // Habilita o CORS para a imagem
//   watermark.src = watermarkUrl; // Caminho local da sua marca d'água

//   watermark.onload = function () {
//     console.log('Marca d\'água carregada com sucesso!');
...
//     const watermarkX = canvasSize.width - watermark.width - 10; // Posição X da marca d'água
//     const watermarkY = canvasSize.height - watermark.height - 10; // Posição Y da marca d'água

//     ctx.drawImage(watermarkCanvas, watermarkX, watermarkY);

//     const finalDataURL = ctx.canvas.toDataURL('image/jpeg', 1.0); // Atualiza o canvas
//     console.log('Imagem com marca d\'água:', finalDataURL);
//     // Use finalDataURL conforme necessário (exemplo: salvar ou exibir)
//   };
// };
    ...
    reader.onload = function (e) {
      ...
      image.onload = function () {
        ...
        const processed = cortes.map((corte) => {
          ...
          // if (addWatermark) {
          //   applyWatermark(ctxCorte, canvasSize);
          // }
